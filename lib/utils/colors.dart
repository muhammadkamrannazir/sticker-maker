...
class AppColors {
  ...
  static var green = const Color(0xffEF5A5A);
  // static var green = Colors.greenAccent.shade400;
  static var greenshade100 = Colors.redAccent.shade100;
  static var greenshade200 = Colors.redAccent.shade200;
